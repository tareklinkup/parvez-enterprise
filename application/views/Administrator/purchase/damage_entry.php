    ...
    <div class="row" style="margin-top: 15px;">
        <div class="col-md-8">
            <form class="form-horizontal" @submit.prevent="addDamage">
				...
				<div class="form-group">
								<label class="col-xs-6 control-label no-padding-right"> Supplier </label>
                                <label class="col-sm-1 control-label no-padding-right">:</label>
								<div class="col-xs-4">
    ...
    new Vue({
        ...
        data(){
            return {
				...
				columns: [
                    ...
                    { label: 'Suppliar', field: 'Supplier_Name', align: 'center' },
        ...
        methods: {
			...
			addDamage(){
				...
				this.damage.Supplier_Id  = this.selectedSupplier.Supplier_SlNo;
            ...
            editDamage(damage){
                ...
                this.selectedSupplier = {
                    Supplier_SlNo: damage.Supplier_Id,
                    display_name: damage.Supplier_Name
                }
            },

    ...
    <div class="row" v-if="showData" style="display:none;" v-bind:style="{ display: showData ? '' : 'none' }">
        ...
        <div class="col-md-2  col-xs-6">
            <div class="widgets" style="border-top: 5px solid #008241;">
                ...
                <div class="widget-content">
                    <div class="widget-text">Monthly Purchase</div>
                    <div class="widget-value"><?php echo $this->session->userdata('Currency_Name');?> {{ thisMonthPurchase | decimal }}</div>
                </div>
            </div>
        </div>
        <div class="col-md-2  col-xs-6">
            <div class="widgets" style="border-top: 5px solid #008241;">
                ...
                <div class="widget-content">
                    <div class="widget-text">Yearly Purchase</div>
                    <div class="widget-value"><?php echo $this->session->userdata('Currency_Name');?> {{ thisYearPurchase | decimal }}</div>
                </div>
            </div>
        </div>
        <div class="col-md-2  col-xs-6">
        ...
        <div class="col-md-2  col-xs-6">
            <div class="widgets" style="border-top: 5px solid #666633;">
                ...
                <div class="widget-content">
                    ...
                    <div class="widget-value"><?php echo $this->session->userdata('Currency_Name');?> {{ monthlyCollection | decimal }}</div>
                </div>
            </div>
        </div>
        <div class="col-md-2  col-xs-6">
            <div class="widgets" style="border-top: 5px solid #666633;">
                ...
                <div class="widget-content">
                    <div class="widget-text">Yearly Collection</div>
                    <div class="widget-value"><?php echo $this->session->userdata('Currency_Name');?> {{ yearlyCollection | decimal }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-2  col-xs-6">
            <div class="widgets" style="border-top: 5px solid #ff8000;">
                ...
                <div class="widget-content">
                    <div class="widget-text">Monthly Customer Due</div>
                    <div class="widget-value"><?php echo $this->session->userdata('Currency_Name');?> {{ monthlyCustomerDue | decimal }}</div>
                </div>
            </div>
        </div>
        <div class="col-md-2  col-xs-6">
        ...
        methods: {
            getGraphData(){
                axios.get('/get_graph_data').then(res => {
                    ...
                    this.thisMonthPurchase  = res.data.this_month_purchase;
                    this.thisYearPurchase   = res.data.this_year_purchase;
                    this.todaysCollection   = res.data.todays_collection;
                    this.monthlyCollection  = res.data.monthly_collection;
                    this.yearlyCollection   = res.data.yearly_collection;
                    this.cashBalance        = res.data.cash_balance;
                    this.customerDue        = res.data.customer_due;
                    this.monthlyCustomerDue = res.data.monthly_customer_due;

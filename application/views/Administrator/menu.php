...
<?php } elseif ($module == 'Administration') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("category_price_update", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>category_price_update">
					<i class="menu-icon fa fa-list"></i>
...
<?php } elseif ($module == 'SalesModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("pos_sales", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>pos_sales">
					<i class="menu-icon fa fa-usd"></i>
					<span class="menu-text"> Pos Sales </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (
			...
			|| array_search("general_customer_list", $access) > -1
			|| isset($CheckSuperAdmin) || isset($CheckAdmin)
		) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>" class="dropdown-toggle">
				...
				<ul class="submenu">
					...
					<?php endif; ?>
					<?php if (array_search("general_customer_list", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>general_customer_list">
								<i class="menu-icon fa fa-caret-right"></i>

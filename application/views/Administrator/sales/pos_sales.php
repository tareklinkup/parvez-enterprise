									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-xs-12">
													<input type="number" id="paid" class="form-control" v-model="sales.cash_amount" v-on:input="calculateTotal"/>
												</div>
											</div>
										</td>
									</tr>
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-xs-12">
													<input type="number" class="form-control" v-model="sales.return_amount" disabled/>
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-xs-6">
													<a class="btn btn-info btn-sm" href="/pos_sales" style="color: black!important;margin-top: 0px;width:100%;padding:5px;font-weight:bold;">New Sale</a>
												</div>
											</div>
										</td>
									</tr>
	...
	new Vue({
		...
		methods:{
			...
			calculateTotal(){
				...
				this.sales.return_amount = (+this.sales.cash_amount - +this.sales.total).toFixed(2);
			...
			async saveSales(){
				...
				if(+this.sales.cash_amount < +this.sales.total){
					alert('Paid need to greater then or equal than total');
					return;
				}

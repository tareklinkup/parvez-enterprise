                        ...
                        <tr v-for="quotation in quotations">
                            ...
                            <td style="text-align:center;">
								...
								<?php if($this->session->userdata('accountType') != 'u'){?>
									...
									<a href="" v-bind:href="`/quotation/${quotation.SaleMaster_SlNo}`" v-if="quotation.is_Sales != 's'" title="Edit Quotation"><i class="fa fa-edit"></i></a>
									<a href="" v-bind:href="`/quotation_sales/${quotation.SaleMaster_SlNo}`" v-if="quotation.is_Sales != 's'" title="Sales"> <i class="fa fa-arrow-right"></i></a>

	...
	<div class="col-xs-9 col-md-9 col-lg-9">
		<div class="widget-box">
			<div class="widget-header">
				<h4 class="widget-title">Quotation Sales Information</h4>
					...
					<div class="row">
						<div class="col-sm-5">
							...
							<div class="form-group clearfix">
								...
								<div class="col-sm-8">
									<input type="text" readonly class="form-control" v-model="quotation.customerName" placeholder="Customer/Company Name">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" readonly placeholder="Mobile No" class="form-control" v-model="quotation.customerMobile" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<textarea placeholder="Address" readonly class="form-control" v-model="quotation.customerAddress"></textarea>
								</div>
							</div>
						</div>
		...
		methods:{
			...
			saveQuotation(){
				...
				axios.post(url, data).then(async res=> {
					...
					if(r.success){
						...
						if(conf){
							window.open('/sale_invoice_print/'+r.quotationId, '_blank');
			...
			getQuotations(){
				axios.post('/get_quotations', {quotationId: this.quotation.quotationId}).then(res=>{
					...
					this.quotation.customerId = quotation.SalseCustomer_IDNo;

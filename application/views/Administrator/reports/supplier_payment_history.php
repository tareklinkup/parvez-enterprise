                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr v-for="payment in payments">
                            ...
                            <td style="text-align:right;">{{ payment.SPayment_discount }}</td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>
                            ...
                            <td style="text-align:right;">{{ payments.reduce((p, c) => { return p + parseFloat(c.SPayment_discount)}, 0).toFixed(2) }}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
		...
		methods:{
			...
			getCustomerPayments(){
				let data = {
					...
					dateTo: this.dateTo,
                    supplierId: this.selectedCustomer == null ? null : this.selectedCustomer.Supplier_SlNo,
			...
			async print(){
                ...
                if(this.selectedCustomer != null){
                    customerText = `
                        <strong>Supplier Code: </strong> ${this.selectedCustomer.Supplier_Code}<br>
                        <strong>Name: </strong> ${this.selectedCustomer.Supplier_Name}<br>
                        <strong>Address: </strong> ${this.selectedCustomer.Supplier_Address}<br>
                        <strong>Mobile: </strong> ${this.selectedCustomer.Supplier_Mobile}<br>
                    `;
                }

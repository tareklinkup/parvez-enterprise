...
$SCP = $this->db->query("SELECT tbl_supplier_payment.*, tbl_supplier.* FROM tbl_supplier_payment LEFT JOIN tbl_supplier ON tbl_supplier.Supplier_SlNo = tbl_supplier_payment.SPayment_customerID WHERE tbl_supplier_payment.SPayment_id = '$PamentID'");
$CPROW = $SCP->row();
...
$totalDue = $type == 'CP' ? ($CPROW->SPayment_amount + $CPROW->SPayment_discount) : $CPROW->SPayment_amount;
...
<a href="<?php echo base_url();?>customerPaymentPage" title="" class="buttonAshiqe">Go Back</a>
    <div id="reportContent">
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-12">
                <h6 style="background:#ddd; text-align: center; font-size: 18px; font-weight: 900; padding: 5px; color: #bd4700;">Supplier Payment Invoice</h6>
            </div>
        </div>
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-12">
                <table style="width: 100%;">
                    <tr>
                        <td style="font-size: 13px; font-weight: 600;"> TR. Id: <?php echo $CPROW->SPayment_invoice; ?></td>
                    </tr>
                    <tr>
                        <td style="font-size: 13px; font-weight: 600; ">TR. Date: <?php echo $CPROW->SPayment_date; ?> </td>
                    </tr>
                    <tr>
                        <td colspan="2" style="font-size: 13px; font-weight: 600; ">Name : <?php echo $CPROW->Supplier_Name; ?></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="font-size: 13px; font-weight: 600; ">Phone No. : <?php echo $CPROW->Supplier_Mobile; ?></td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="col-xs-12">
                <table class="border" cellspacing="0" cellpadding="0" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <td style="text-align:right;"><?php echo number_format($CPROW->SPayment_discount, 2) ?></td>
                        </tr>
                        <tr>
                            ...
                            <th style="font-size: 13px; font-weight: 700;text-align:right;"><?php echo number_format($CPROW->SPayment_discount, 2) ?></th>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-12">
                <h6 style=" font-size: 12px; font-weight: 600;">Paid (In Word): <?php echo convertNumberToWord($CPROW->SPayment_amount);?></h6>
            </div>
        </div>
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-12 text-left;">
                <table style="width: 25%;float:left;">
                    ...
                    <tr>
                        ...
                        <td  style="font-size: 13px; font-weight: 600;text-align: right; "><?php echo number_format($CPROW->SPayment_amount, 2); ?></td>
                    </tr>
                    <tr>
                        <td  style="font-size: 13px; font-weight: 600; border-bottom: 2px solid #000; ">Discount : </td>
                        <td  style="font-size: 13px; font-weight: 600; border-bottom: 2px solid #000; text-align: right; "><?php echo number_format($CPROW->SPayment_discount, 2); ?></td>
                    </tr>
                    <tr>

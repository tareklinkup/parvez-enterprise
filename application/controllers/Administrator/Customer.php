...
class Customer extends CI_Controller
{
    ...
    public function getCustomers(){
        ...
        $general_clause = " and c.Customer_Type != 'G'";
    ...
    function cashTransationAndReport($id = Null)
    {
        ...
        $data['content'] = $this->load->view('Administrator/due_report/cashTransationAndReport', $data, TRUE);
        $this->load->view('Administrator/index', $data);
    }

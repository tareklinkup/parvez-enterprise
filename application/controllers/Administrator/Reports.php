...
class Reports extends CI_Controller {
    ...
    public function general_customer_list(){
        $data['title'] = "General Customer List";
        $data['content'] = $this->load->view('Administrator/reports/general_customer_list', $data, true);
        $this->load->view('Administrator/index', $data);
    }
